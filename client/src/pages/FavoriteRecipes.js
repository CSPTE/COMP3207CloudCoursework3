...
export default function FavoriteRecipes() {
	...
	const getRecipes = async (email) => {
		const resp = await axios.post("https://izifood.azurewebsites.net/api/updateFavorite?code=xKSI2S3EexvVi419ILcv4l6cQ6OrFmTKNO8M-iHqd8HrAzFuggm15g==", { email: email, action: "getAll" })
		...
		await getFavorites(resp.data.data)
	}
